...
const ProfilePage = async() => {
  ...
  return (
    <>
      <main className="flex flex-col justify-center min-h-[500px] items-center">
         <div className="card w-10/12 flex flex-col justify-center items-center px-5 py-5 shadow-2xl md:w-1/3 min-h-[200px]">
